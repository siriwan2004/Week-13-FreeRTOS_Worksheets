...
ป้องกันการรีเซ็ตผิดพลาด (false positive)

ตรวจจับ task ที่หยุดทำงานจริง

ทำให้ Watchdog มีอิสระในการตรวจสอบ System Health

2. **Pattern Timing**: อธิบายการเลือก Timer Period สำหรับแต่ละ pattern

Timer Period ถูกกำหนดให้สอดคล้องกับ พฤติกรรมของระบบและความถี่ที่ผู้ใช้มองเห็นได้ชัดเจน

3. **Sensor Adaptation**: ประโยชน์ของ Adaptive Sampling Rate คืออะไร?

Adaptive Sampling คือการ ปรับความถี่การอ่านค่า Sensor แบบอัตโนมัติ
ในระบบนี้ ถ้าอุณหภูมิสูง → จะอ่านถี่ขึ้น, ถ้าค่าคงที่ → อ่านช้าลง

4. **System Health**: metrics ใดบ้างที่ควรติดตามในระบบจริง?

Timer System,Sensor System,Performance,Memory,System Uptime,Pattern Activity
