...
|-------|--------|------|---------|-------|-------|---------|
| 1 (ปกติ) |12 |8 |15 | 3|38 |ระบบทำงานปกติ Processor Task รับข้อมูลจากทุก Queue อย่างต่อเนื่อง LED ทุกดวงกะพริบตามเหตุการณ์ |
| 2 (ไม่มี Sensor) | 0|9 |16 |3 |28 | ไม่มีข้อมูลจาก Sensor แต่ระบบยังทำงานปกติ Processor รับเฉพาะจาก User, Network และ Timer|
| 3 (Network เร็ว) | 10| 8|40 |3 | 61|Network Queue ส่งข้อมูลถี่ Processor ประมวลผลบ่อย LED Network และ Processor กะพริบเร็วขึ้น ระบบยังคงตอบสนองดี |
