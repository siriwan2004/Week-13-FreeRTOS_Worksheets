...
Single Task: ตอบสนองช้าเพราะทำงานเรียงลำดับ

Multitasking: ตอบสนองไวกว่าเพราะมี task ตรวจปุ่มโดยเฉพาะ

2. ใน Single Task System งานไหนที่ทำให้การตอบสนองล่าช้า?

งานประมวลผลข้อมูล (Processing data) ที่ใช้เวลานานมาก

3. ข้อดีของ Multitasking System ที่สังเกตได้คืออะไร?

งานหลายอย่างทำพร้อมกันได้ 

ตอบสนองต่อเหตุการณ์ได้รวดเร็ว
