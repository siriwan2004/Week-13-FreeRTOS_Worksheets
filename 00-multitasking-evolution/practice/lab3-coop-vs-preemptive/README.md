...
Preemptive → RTOS บังคับสลับเอง (เร็วกว่า)
Cooperative → ต้องรอ Task ยอม (ช้ากว่า)

2. ข้อดีของ Cooperative Multitasking คืออะไร?

โครงสร้างง่าย – ไม่ต้องจัดการ Priority หรือ Context Switch มาก

Debug ง่าย – ลำดับการทำงานเป็นไปตามที่เขียน ไม่มีการแทรกกลาง

ใช้ทรัพยากรน้อยกว่า – ไม่มี Overhead จาก Context Switching

เหมาะกับระบบเล็กๆ / Non-real-time เช่น โปรแกรมไมโครคอนโทรลเลอร์ขนาดเล็ก หรือระบบฝึกสอน

3. ข้อเสียของ Cooperative Multitasking คืออะไร?

Response Time ไม่แน่นอน – ถ้า Task หนึ่งรันนานเกินไป Task อื่นจะถูกหน่วง

Task หนึ่งอาจบล็อกระบบทั้งหมด ถ้าไม่ยอม “yield” หรือ delay

ไม่เหมาะกับงาน Real-time ที่ต้องตอบสนองทันที

การออกแบบต้องอาศัยวินัยของผู้เขียนโค้ด

4. ในสถานการณ์ใดที่ Cooperative จะดีกว่า Preemptive?

ระบบที่ ไม่ต้องการความเร็วหรือความแม่นยำสูง

ทรัพยากรจำกัดมาก (MCU หน่วยความจำต่ำ)

งานลำดับขั้นตอนแน่นอน และสามารถควบคุมเวลาได้ด้วยตนเอง

การสอนพื้นฐานระบบหลายงาน ที่ต้องการเห็น flow การสลับงานแบบชัดเจน

5. เหตุใด Preemptive จึงเหมาะสำหรับ Real-time systems?

Preemptive ให้ ความแน่นอน, เวลาตอบสนองเร็ว, และ เหมาะกับงาน Real-time เช่น ระบบความปลอดภัย, หุ่นยนต์, เครื่องมือแพทย์, IoT ที่ต้องตอบสนองทันที
